# sonicexe-adventure-dev-build-005
there is bugs
...
game.onUpdateInterval(5000, function () {
    sonicexe = sprites.createProjectileFromSide(assets.image`sonicexe`, randint(20, 20), randint(20, 20))
    ...
    animation.runImageAnimation(
    sonicexe,
    assets.animation`sonicexee0`,
    500,
    true
    )
    animation.runImageAnimation(
    sonicexe,
    assets.animation`sonicexee1`,
    50,
    true
    )
    animation.runImageAnimation(
    sonicexe,
    assets.animation`exe`,
    50,
    true
    )
    info.setLife(3)
